...
def view_total_customers(
    ...
    print("There are currently {} customers across your managed branch.".format(get_total_customers(engine, manager_ssn)))
  
def view_total_money_held_by_accounts(
    engine,
    manager_ssn: str,
    user_is_customer: bool = False, 
) -> None:
    ...
    print("There is currently ${} held by accounts in your managed branch.".format(get_total_money(engine, manager_ssn)))

def view_total_salaries_of_employees(
    engine,
    manager_ssn: str,
    user_is_customer: bool = False, 
) -> None:
    ...
    print("There is currently ${} being paid to each employee of your managed branch.".format(get_total_employee_salary_(engine, manager_ssn)))